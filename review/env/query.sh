...
#   query.sh verid   <name> [type]   # veri-dns  (203.0.113.2:5300)
#   query.sh unbound <name> [type]   # unbound   (203.0.113.3:5301)
...
type="${3:-A}"
case "$target" in
  verid)   ip=203.0.113.2;  port=5300 ;;
  unbound) ip=203.0.113.3;  port=5301 ;;
