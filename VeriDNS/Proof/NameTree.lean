              ...
              | some resp =>
                ...
                ·
                  ...
                  ·
                    ...
                    refine SatisfiesM.bind (satisfiesM_true _) ?_
                    intro _ _
                    have hrc : resp.header.rcode = Rcode.nameError := by
                      rw [Bool.and_eq_true] at hguard
                      exact strictDenialB_rcode hguard.2
                    exact SatisfiesM.pure
                      ⟨fun f hf => by
                          cases hf
                          exact finalizeAnswer_answer_agrees hs.chain hcons.answer,
                        cacheAgrees_storeProbeNegative hs.cache
                          (probeAbsent_of_strictDenial hacc hcons hrc)⟩
                  ·
                    split
                    ·
                      refine SatisfiesM.bind (satisfiesM_true _) ?_
